...
with(this){return _c('ol',[_c('li',[_v("User input command to adds in the corresponding tags for the particular client identifier or index")]),_v(" "),_c('li',[_v("Systems displays the tags that have been added to the particular client"),_c('br'),_v("\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs invalid client identifier"),_c('br'),_v("\n1a1. System displays an error message indicating that the process of adding tags have failed"),_c('br'),_v("\nUse case ends")])]),_v(" "),_c('li',[_c('p',[_v("1b. User inputs in invalid index"),_c('br'),_v("\n1b1. System displays an error message indicating that the process of adding tags have failed"),_c('br'),_v("\nUse case ends")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User input command to highlight the client preferred form of contact")]),_v(" "),_c('li',[_v("System updates with the preferred form of contact highlighted"),_c('br'),_v("\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs invalid client identifier"),_c('br'),_v("\n1a1. System displays an error message indicating that the process of selecting preferred form of contact have failed"),_c('br'),_v("\nUse case ends")])]),_v(" "),_c('li',[_c('p',[_v("1b. User inputs invalid index"),_c('br'),_v("\n1b1. System displays an error message indicating that the process of selecting preferred form of contact have failed"),_c('br'),_v("\nUse case ends")])]),_v(" "),_c('li',[_c('p',[_v("1c. User inputs multiple forms of contacts"),_c('br'),_v("\n1c1. System displays an error message to tell the user to select only one form of preferred contact and that the\nprocess of selecting preferred form of contact have failed"),_c('br'),_v("\nUse case ends")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User keys in new client with its details")]),_v(" "),_c('li',[_v("System updates with new client at the bottom of the list"),_c('br'),_v("\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User keys in wrong input format"),_c('br'),_v("\n1a1. System displays an error message indicating the supposed format to be changed"),_c('br'),_v("\nUse case ends")])]),_v(" "),_c('li',[_c('p',[_v("1b. User keys in wrong format for details"),_c('br'),_v("\n1b1. System displays an error message indicating that a particular detail is in the wrong format"),_c('br'),_v("\nUse case ends")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User inputs in command filter by tags")]),_v(" "),_c('li',[_v("System updates with a list of clients that fulfills the tags to be filtered"),_c('br'),_v("\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. User keys in invalid tags"),_c('br'),_v("\n1a1. System displays an error message to remind user to check their tags that is keyed in"),_c('br'),_v("\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User inputs command to store client information and documents")]),_v(" "),_c('li',[_v("System opens up the folder of the particular client with the relevant files inside the folder"),_c('br'),_v("\nUse case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User keys in invalid client identifier"),_c('br'),_v("\n1a1. System displays an error message indicating that the process of adding tags have failed"),_c('br'),_v("\nUse case ends")])]),_v(" "),_c('li',[_c('p',[_v("1b. User keys in invalid index"),_c('br'),_v("\n1b1. System displays an error message indicating that the process of adding tags have failed"),_c('br'),_v("\nUse case ends")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Thu, 5 Oct 2023, 11:18:14 GMT+8]")])])])}
}];
