...
with(this){return _c('p',[_v("Step 1.\nThe user launches the application. The current "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filteredPersonList")]),_v(" is simply a list of all Person objects\nin the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter t/Friend")]),_v(" command to filter for all Person objects in the address book\nwith the tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Friend'")]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter")]),_v(" command calls the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ParseCommand")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" which\nreturns a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommandParser")]),_v(" object.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommandParser")]),_v(" object then calls its "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("parse")]),_v(" method, returning a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommand")]),_v(" object\nwhich is executed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(", calling the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateFilteredPersonList")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The update list of filtered "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects are then displayed on the ui.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, OS-X")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": A tag object assigned to a contact that is a categorical description of the contact")]),_v(" "),_c('li',[_c('strong',[_v("Client Priorities")]),_v(": Priority of the client that the insurance agent has to attend to, where each priority is its own tag")]),_v(" "),_c('li',[_c('strong',[_v("Usage Instructions")]),_v(": A quickstart guide with a short list of basic commands for users' reference within the App.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Return to "),_c('a',{attrs:{"href":"#table-of-contents"}},[_v("Table Of Contents")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sat, 11 Nov 2023, 15:40:05 GMT+8]")])])])}
}];
